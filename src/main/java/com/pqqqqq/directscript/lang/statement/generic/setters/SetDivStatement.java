 ...
 * A statement that sets the value of an existing {@link Variable} by dividing by its current value
 */
public class SetDivStatement extends Statement<Object> {

    public SetDivStatement() {
    ...
    public Result<Object> run(Context ctx) {
        ...
        mutableValue.setDatum(mutableValue.getDatum().get().or(0D).div(value)); // Null values will just be 0
