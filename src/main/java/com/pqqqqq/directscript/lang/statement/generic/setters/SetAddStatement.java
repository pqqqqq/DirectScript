 ...
 * A statement that sets the value of an existing {@link Variable} by adding its current value
 */
public class SetAddStatement extends Statement<Object> {

    public SetAddStatement() {
    ...
    public Result<Object> run(Context ctx) {
        ...
        mutableValue.setDatum(mutableValue.getDatum().get().add(value)); // Null values will just be 0
